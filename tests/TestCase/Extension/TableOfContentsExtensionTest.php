...
DJOT;
    ...
    {
        $this->markTestSkipped('Raw inline `x`{=html} is modeled as Code, not RawInline; excluding it from heading/TOC text needs raw-inline modeling work tracked separately (unrelated to the heading cluster).');
