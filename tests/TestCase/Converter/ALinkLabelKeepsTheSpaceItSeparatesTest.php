...
/**
 * A link label keeps one edge space where it is all that separates the label
 * from its neighbor, as a formatting element does (#2094).
 */
class ALinkLabelKeepsTheSpaceItSeparatesTest extends TestCase
{
    ...
    public static function shapes(): array
    {
        return [
            ...
            'a collapsed reference' => ['<p><a href="u" data-djot-ref="">x </a>y</p>', "[x ][x]y\n\n[x]: u\n"],
