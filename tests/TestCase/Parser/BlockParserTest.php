...
class BlockParserTest extends TestCase
{
    ...
    public function testColonsInsideRawBlockDoNotCloseAutoClosedDiv(): void
    {
        // A ::: line inside a raw ``` =format block is opaque: with EOF
        // auto-close it must stay inside the div's raw block body, not close the
        // div before the raw fence's own closer.
        ...
        $divChildren = $children[1]->getChildren();
        $this->assertInstanceOf(RawBlock::class, $divChildren[0]);
    }
