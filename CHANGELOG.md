...
- **A quote's consecutive inline children import as one paragraph** (#2102), instead of one paragraph each, so `<blockquote>a <b>b</b> c</blockquote>` reads back as the line the HTML held.
